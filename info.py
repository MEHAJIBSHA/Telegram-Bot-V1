...
#main variables
API_ID = int(environ.get('27934630', ''))
API_HASH = environ.get('5fbce12d70c2bdedf8b1e549e8ae818b', '')
BOT_TOKEN = environ.get('BOT_TOKEN', '7699429910:AAGYvMfKFjlmr03l-6ftx4YoeuVjJXoulxg')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5529765823').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/mehajibsha")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-10019494867581'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/malayalam_moves_786')
